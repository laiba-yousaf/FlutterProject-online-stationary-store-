...
class officecorner extends StatefulWidget {
  const officecorner({super.key});

  @override
  State<officecorner> createState() => _officecornerState();
}

class _officecornerState extends State<officecorner> {
  List supply = [
    {
      "img": 'assets/oc1.png',
    },
